...
const ProjectCaseStudy = () => (
    <section className="flex flex-col md:flex-row border-y border-neutral-800 font-mono min-h-[600px]">
        ...
        <div className="flex-1 bg-[#111] text-white p-16 md:p-24 flex flex-col justify-center relative overflow-hidden group border-b md:border-b-0 md:border-r border-neutral-800">
            <div className="absolute top-4 left-4 text-green-500 text-xs tracking-widest animate-pulse">
        ...
        <div className="flex-1 bg-[#e5e5e5] text-black p-16 md:p-24 flex flex-col justify-center relative">
            <div className="absolute top-4 right-4 text-blue-600 text-xs tracking-widest">
                ✓ EXECUTING_WORKFLOW
            </div>
