...
skills:
  - name: Past-hire calibration
    ...
    body: |
      Pull what worked from the last successful hires in this role before any draft starts.
  ...
  - name: Sourcing brief format
    ...
    body: |
      Turn the calibrated JD into a brief a sourcer can act on without asking follow-up questions.
